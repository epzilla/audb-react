...
const BAButton = ({ code, btn, index, pattern, onTouchend }) => {
  ...
  return (
    <div className="flex flex-center flex-col no-swipe" onTouchStart={(e) => e.stopPropagation()} onTouchEnd={(e) => onTouchend(e, code)} >
      <div className={ classes }></div>
      <label className="no-swipe">{ btn }</label>
    </div>
  );
};

// export const NotSoSecretCode: FC = (props) => {
...
export class NotSoSecretCode extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    //   return (
    //     <div className="secret-modal modal flex-center" style={ bgImgStyle }>
    //       <button className="dismiss-btn" onClick={() => this.dismiss()}>&times;</button>
    ...
    //   }
      ...
      // return (
      //   <div id="touchpad"
      //     className={this.state.isShowingTouchpad ? 'touchpad show' : 'touchpad'}
      //     onTouchstart={(e) => this.onTouchstart(e)}
      //     onTouchmove={(e) => this.onTouchmove(e)}
      //   >
      //     <div className={this.state.isShowingTouchpad ? 'touch-hint flip' : 'touch-hint'}></div>
      //     <div className="emoji-hint">
      //       <h1>{ emoji }</h1>
      //     </div>
      //     <div className="touch-controller flex-space-between">
      //       <div className="d-pad flex no-swipe">
      //         <div className="flex flex-center no-swipe">
      //           <DPadButton
      //             code={38}
      //             index={this.index}
      //             dir={'up'}
      ...
      //           />
      //           <div className="d-pad-button center-button no-swipe"></div>
      //           <DPadButton
      //             code={39}
      //             index={this.index}
      //             dir={'right'}
      ...
      //         </div>
      //       </div>
      //       <div className="b-a-buttons flex no-swipe">
      //         <BAButton
      //           code={66}
      //           index={this.index}
      //           btn="B"
